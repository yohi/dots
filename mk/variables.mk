...
.PHONY: all help setup-system install-packages-homebrew install-packages-apps install-packages-deb install-packages-flatpak \
        ...
        setup-config-mozc setup-config-mozc-ut-dictionaries setup-config-mozc-ut-dictionaries-manual get-mozc-dict-checksum check-mozc-import-status setup-mozc-perfect \
