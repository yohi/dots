...
.PHONY: all help setup-system install-packages-homebrew install-packages-apps install-packages-deb install-packages-flatpak \
        ...
        setup-gnome-extensions setup-gnome-tweaks backup-gnome-tweaks export-gnome-tweaks setup-all install-cursor update-cursor stop-cursor check-cursor-version install-supercursor install-wezterm install-fuse install-claude-code install-claudia install-claude-ecosystem setup-claude \
        ...
        install-gemini-cli install-supergemini install-gemini-ecosystem install-packages-ccusage install-ccusage \
