...
.PHONY: all help setup-system install-packages-homebrew install-packages-apps install-packages-deb install-packages-flatpak \
        ...
        setup-gnome-extensions setup-gnome-tweaks setup-gnome-wezterm check-gnome-wezterm test-gnome-wezterm restart-nautilus backup-gnome-tweaks export-gnome-tweaks setup-all install-cursor update-cursor stop-cursor check-cursor-version install-wezterm install-fuse install-claude-code install-claudia install-superclaude install-claude-ecosystem fix-superclaude install-cica-fonts install-mysql-workbench setup-claude \
